...
// shared variable
static int emergency_trigger = 0;
...
// scheduling -> task
signal_sch signal_scheduling_task = signal_sch(period_signal,&signal_state_duration, &current_signal_state, &emergency_trigger);
emergency_l emergency_listener_task = emergency_l(period_emergency ,&emergency_trigger);
